...
urlpatterns = [
    ...
    path('admin/orders/<int:pk>/delivery-audits/', views.AdminOrderDeliveryAuditListCreateView.as_view(), name='admin-order-delivery-audits'),
    ...
    path('admin/finance/', views.AdminFinanceDashboardView.as_view(), name='admin-finance'),
    path('admin/finance/reports/', views.AdminReportsView.as_view(), name='admin-finance-reports'),
    path('admin/finance/reports/download/', views.AdminDownloadReportView.as_view(), name='admin-finance-reports-download'),
    path('admin/finance/payments/', views.AdminPaymentIntentListView.as_view(), name='admin-finance-payments'),
    path('admin/finance/payments/<int:pk>/', views.AdminPaymentIntentDetailView.as_view(), name='admin-finance-payment-detail'),
    path('admin/finance/payments/<int:pk>/reconcile/', views.AdminPaybillReconcileView.as_view(), name='admin-finance-payment-reconcile'),
    path('admin/finance/invoices/', views.AdminInvoiceListView.as_view(), name='admin-finance-invoices'),
    path('admin/finance/invoices/<int:pk>/', views.AdminInvoiceDetailView.as_view(), name='admin-finance-invoice-detail'),
    path('admin/finance/returns/', views.AdminReturnRequestListView.as_view(), name='admin-finance-returns'),
    path('admin/finance/returns/<int:pk>/', views.AdminReturnRequestDetailView.as_view(), name='admin-finance-return-detail'),
